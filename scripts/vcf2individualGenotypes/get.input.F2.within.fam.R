...
name <-  "test"
fileHap1 <- paste0(outFolder,  "/F2_", name, "within.fam.bins",  cutoffLevel, "_",  Sys.Date())
...
read_grand.p(f2.ped, vcf.file = vcf.file.f2, pathout = outFolder, py = py.script, generate.input = TRUE)
